...
const mock: InternShipType[] = [
  {
    ...
    workTechContent: [
      ...
      "探索基于express+openai搭建简单的node服务，包括mcp tools自主调用能力+维护业务枚举+prompt调整，实现了基于需求tapd链接/markdown文档转json配置的能力，为组内下半年O2规划快速搭建Bi数据看板提供了更多元的配置生成方案",
    ],
    techStack: ["Vue2.7/3.4", "TypeScript", "TDesign", "Wujie微前端", "Monorepo", "Nodejs/Express"],
  },
  {
