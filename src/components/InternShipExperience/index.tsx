...
const mock: InternShipType[] = [
  {
    ...
    discription: "",
    workContent: [
      "参与腾讯游戏 流量生态部 广告投放业务线大O2(国内版/海外版) 流量池项目的开发、维护工作；该项目面向腾讯游戏下属各个工作室部门、代投商，提供了腾讯游戏实现通过媒体买量、内容带量实现用户增长的一套集投放策略制定、素材审核、广告投放、数据归因为一体的广告投放平台；实习期间深度参与素材中心、数据中心、媒体中心等模块的建设、迭代工作，同时负责沉淀多个flux-Component业务组件以提升研效，并积极参与AI Agent开发能力落地的探索与实践；",
    ],
    workTechContent: [
